...
urlpatterns = [
    ...
    path('teams/<int:team_pk>/invites/<int:invite_pk>/resend/', TeamInviteResendView.as_view(), name='team-invite-resend'),
    ...
    path('team-invites/<str:token>/signup/', TeamInviteSignupView.as_view(), name='team-invite-signup'),
